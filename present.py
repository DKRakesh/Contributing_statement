...
import pandas as pd
import sklearn
#from simpletransformers.classification import (ClassificationArgs1,ClassificationModel1,)
...
df = pd.read_csv('all_sent_eval.csv')
...
pos.to_csv('pos_sent_eval.csv', index=False)
