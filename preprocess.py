...
base_dir = "C:/Users/LENOVO/Predi/own/trial_data"
sep = os.path.sep
print(sep)
...
def load_data_sentence(file_path):
    ...
    for tuple in file_path:
        ...
        paper_data, paper_triple_stat = load_paper_sentence(sentence_path, label_path)
        for i in range(5):
...
print('\n\"all_sent.csv\" and \"pos_sent.csv\" have been saved to ./own')
